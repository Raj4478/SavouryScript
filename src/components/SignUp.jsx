...
<motion.div initial={{x:-70}} animate={{x:0}} transition={{delay:0.5,duration:1}} className='grid max-[900px]: grid-cols-2 h-screen'>


   <form onSubmit={handleSubmit(onSubmit)} className='grid justify-center border-2 max-[900px]:w-screen    items-center grid-flow-row'>
...
<p className='mt-10 p-2'>Already have an Account?  <Link to="/login" className='text-red-300 border-b border-white duration-500 hover:border-red-300'>Log In</Link></p>
   ...
   <motion.div initial={{y:-100}} animate={{y:0}} transition={{delay:0.5,duration:1}} className='bg-pic2 max-[900px]:hidden bg-cover bg-no-repeat'>
